...
public class ABOpening extends Morris {

	static int totalpositionevaluated;
	static int score = Integer.MIN_VALUE;

	public static List<Character> ABminimaxopening(List<Character> board, int depth) {
		...
		for (List<Character> alist : allPossibleMoves) {
			tempscore = minimax(alist, 0, depth - 1, alpha, beta);
