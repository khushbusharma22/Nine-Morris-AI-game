...
public class MiniMaxOpening extends Morris {

	static int totalpositionevaluated;
	static int score = Integer.MIN_VALUE;

	public static List<Character> minimaxopening(List<Character> board, int depth) {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Output Board/Best Move:" + sb);
