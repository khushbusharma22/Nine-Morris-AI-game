...
public class MiniMaxGameBlack extends Morris {

	static int totalpositionevaluated;
	static int score = Integer.MIN_VALUE;

	public static List<Character> minimaxgameblack(List<Character> board, int depth) {
	...
	public static void main(String[] args) throws IOException {
		...
		successmove = minimaxgameblack(board, depth);
