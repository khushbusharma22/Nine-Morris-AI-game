...
public class MiniMaxOpeningImproved extends Morris {
	...
	public static int minimax(List<Character> list1, int player, int depth) {
		...
		if (depth == 0) {
			...
			return Morris.stestopeningimprove(list2);
